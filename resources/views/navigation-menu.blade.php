<nav x-data="{ open: false }"
        ...
        <div class="flex justify-between h-16">
            <div class="flex">
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                    <x-nav-link href="{{ route('foco.today') }}" :active="request()->routeIs('foco.today')">
                        FOCO
                    </x-nav-link>

                    <x-nav-link href="{{ route('foco.summary') }}" :active="request()->routeIs('foco.summary')">
                        Resumen
                    </x-nav-link>

                    <x-nav-link href="{{ route('foco.week') }}" :active="request()->routeIs('foco.week*')">
                        Semana
                    </x-nav-link>
    ...
    <div :class="{'block': open, 'hidden': ! open}" class="hidden sm:hidden">
        <div class="pt-2 pb-3 space-y-1">
            <x-responsive-nav-link href="{{ route('foco.today') }}" :active="request()->routeIs('foco.today')">
                FOCO
            </x-responsive-nav-link>

            <x-responsive-nav-link href="{{ route('foco.summary') }}" :active="request()->routeIs('foco.summary')">
                Resumen
            </x-responsive-nav-link>

            <x-responsive-nav-link href="{{ route('foco.week') }}" :active="request()->routeIs('foco.week*')">
                Semana
            </x-responsive-nav-link>
